...
import avrlankaweb from "../assets/avrlankaweb.png"; // Make sure this image exists

const techStack = [
  { name: "WordPress", icon: <FaWordpress className="text-blue-600" /> },
];

const ProjectDetailAVRLankaTours = () => {
      ...
      >
        ...
        <div className="text-center p-10 border-b border-white/10">
          ...
          <p className="text-gray-400 mt-4 max-w-3xl mx-auto">
            AVR Lanka Tours is a tourism website offering package listings and
            inquiry management. It helps travelers discover and book tours
            easily while providing contact options for questions and support.
          </p>
        </div>
...
export default ProjectDetailAVRLankaTours;
