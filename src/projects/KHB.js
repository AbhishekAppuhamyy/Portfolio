      ...
      >
        ...
        <div className="text-center p-10 border-b border-white/10">
          ...
          <p className="text-gray-400 mt-4 max-w-3xl mx-auto">
            KHB Associates is a custom corporate website focused on building
            trust through professional aesthetics and modern design. It includes
            sections for services, client testimonials, and a contact form.
          </p>
        </div>
