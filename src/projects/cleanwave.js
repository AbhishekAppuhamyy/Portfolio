...
import { FaHtml5, FaCss3Alt, FaServer } from "react-icons/fa";
import { Java, SiMysql } from "react-icons/si";
import cleanwave from "../assets/cleanWave.png"; // Make sure this image exists

const techStack = [
  { name: "JSP", icon: <FaServer className="text-yellow-500" /> }, // Using server icon for JSP
  { name: "MySQL", icon: <SiMysql className="text-blue-600" /> },
  { name: "HTML", icon: <FaHtml5 className="text-orange-600" /> },
  { name: "CSS", icon: <FaCss3Alt className="text-blue-600" /> },
];

const ProjectDetailCleanWave = () => {
      ...
      >
        ...
        <div className="text-center p-10 border-b border-white/10">
          ...
          <p className="text-gray-400 mt-4 max-w-3xl mx-auto">
            CleanWave Laundry is a full-featured laundry management system with
            online booking capabilities. It enables customers to schedule
            pickups and track orders, while staff can manage workflows and
        ...
        <div className="grid md:grid-cols-2 gap-8 p-10">
          ...
          >
            ...
            <a
              href="https://github.com/AbhishekAppuhamyy/CleanWave"
              target="_blank"
...
export default ProjectDetailCleanWave;
