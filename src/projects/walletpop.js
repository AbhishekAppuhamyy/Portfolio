...
import walletpop from "../assets/walletpop.png"; // Add your WalletPop image here
      ...
      >
        ...
        <div className="text-center p-10 border-b border-white/10">
          ...
          <p className="text-gray-400 mt-4 max-w-3xl mx-auto">
            Walletpop is an Android mobile application developed using Kotlin and XML layouts. It helps travelers, business professionals, and digital nomads manage tasks, trips, and expenses efficiently using Shared Preferences and Firebase for backend services.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 p-10">
          ...
          >
            ...
            <a
  href="https://github.com/AbhishekAppuhamyy/Financial-Tracking-App"
  target="_blank"
...
export default ProjectDetailWalletPop;
