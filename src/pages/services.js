  ...
  const services = [
    {
      ...
      icon: <FaReact className="text-4xl text-cyan-400 animate-bounce" />,
    },
    {
    ...
    },
    {
      ...
      icon: <FaFigma className="text-4xl text-pink-400 animate-spin-slow" />,
    },
    {
      title: "Website Maintenance",
      description:
        "Regular updates, backups, and performance optimization to keep your site running smoothly.",
      icon: <FaTools className="text-4xl text-yellow-400 animate-wiggle" />,
    },
    {
      title: "WordPress Development",
      description:
        "Custom WordPress themes and plugins to enhance your website's functionality.",
      icon: <FaWordpress className="text-4xl text-blue-400 animate-float" />,
    },
  ];
